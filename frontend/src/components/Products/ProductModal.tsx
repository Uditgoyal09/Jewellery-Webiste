...
import { apiCreateProductInquiry, ApiError, type Product } from '@/lib/api';
...
export const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: error instanceof ApiError ? error.message : 'Failed to submit inquiry. Please try again.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
