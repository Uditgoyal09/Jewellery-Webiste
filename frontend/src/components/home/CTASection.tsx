      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="glass-card p-6 rounded-lg hover-lift animate-enter" style={{ animationDelay: '0.12s' }}>
            ...
            <div className="glass-card p-6 rounded-lg hover-lift animate-enter" style={{ animationDelay: '0.22s' }}>
